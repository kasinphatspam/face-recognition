  ...
  return (
    <>
      ...
      <div className="w-full min-h-full bg-gradient-to-r from-[#F1F0E8] to-blue-50 dark:from-zinc-900 dark:to-neutral-800 from-45% to-120% duration-150 ease-in dark:ease-out">
        <h1 className="text-6xl font-bold mb-16 pt-10 flex justify-center">Subscription</h1>
        <div className="flex justify-center mx-auto max-w-[1000px]">
          <div className="flex flex-row gap-10">
            ...
            <img
              ...
              alt="Subscription"
              className="max-w-[200px] h-auto border rounded-lg"
        ...
        <div className="flex justify-center">
          <div>
            <motion.div className="flex flex-col items-center justify-center min-h-[800px] pt-24 pb-8 max-sm:pt-8"
