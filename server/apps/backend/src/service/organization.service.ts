...
export class OrganizationService {
    ...
    public async getOrganizationById(organizationId: number): Promise<Organization> {
        return await this.organizationRepository.findOneBy({ organizationId: organizationId })
    }
    ...
    public async createNewOraganization(userId: number, body: CreateOrganizationDto) {
    ...
    public async updateOrganizationInfo(organizationId: number, body: UpdateOrganizationDto) {
    ...
    public async deleteOrganization(organizationId: number) {
        return await this.organizationRepository.delete({ organizationId: organizationId })
    }
