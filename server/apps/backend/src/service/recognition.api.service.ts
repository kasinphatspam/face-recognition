...
import { CreatePackageResponseDto, EncodeImageResponseDto, RecognitionImageResponseDto } from 'src/utils/dtos/contact.dto';
...
export class RecognitionApiService {
    ...
    public async createPackage() {
        ...
        let obj: CreatePackageResponseDto = await JSON.parse(JSON.stringify(result))
